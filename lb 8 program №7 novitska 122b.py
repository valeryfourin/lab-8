...
print('\nINFORMATION ABOUT GROUPS, PRODUCTS AND QUANTITIES:\n')     # інформація про всі продукти кожної групи та їх к-ть
print('For group "mlk":')
...
while True:
    while True:
        try:
            ...
            # при першому продукти виводяться у зростаючому порядку їх кількості в кожній групі
            # при другому продукти виводяться у спадному порядку їх кількості в кожній групі
            # при третьому продукти виводяться у алфавітному порядку в кожній групі
            # при четвертому продукти виводяться у алфавітному зворотньому порядку їх кількості в кожній групі
